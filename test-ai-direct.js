...
async function testAIDirectly() {
  try {
    ...
    console.log('Testing AI directly with WhatsApp image...');
    ...
    // Create the prompt
    const prompt = `You are an expert at extracting JEE/NEET multiple choice questions from images.
    
    Please analyze this image and extract all the multiple choice questions you can find.
    These are typically physics, chemistry, mathematics, or biology questions for competitive exams.
